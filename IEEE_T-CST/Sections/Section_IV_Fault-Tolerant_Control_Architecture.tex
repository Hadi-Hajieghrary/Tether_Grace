...
\begin{itemize}
  ...
  \item The finite-time transient prediction ($\alpha \approx 5.8$, topology-invariant) and the cost ratio $\rho_{\mathrm{FT}} = N/(N{-}k)$ are \emph{derived analytically and validated} against full-Drake results.
