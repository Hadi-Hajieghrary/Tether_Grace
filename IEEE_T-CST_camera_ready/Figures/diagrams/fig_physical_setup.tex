% ============================================================
%  Figure 1 — Physical configuration of the cooperative
%             aerial transport system. (Cleaned layout.)
% ============================================================
\begin{figure}[t]
\centering
\begin{tikzpicture}[
  ...
  \node[lab, teal!60!black, anchor=west] at (3.6, 0.25)
...
own state, its own scalar tension $T_i$, and the local payload state
$x_L$; no peer drone or peer-cable signal is exchanged. The plant is
