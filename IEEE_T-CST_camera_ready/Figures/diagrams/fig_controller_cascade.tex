...
\begin{tikzpicture}[
  ...
  \node[sum, fill=red!10] (sumT) at (0, 1.2) {$+$};
...
$T_i^{\mathrm{ff}} = T_i$. This identity supplies the bounded-jump
mechanism used in the hybrid practical-ISS certificate of
\cref{thm:hybrid-stability}; the surrounding cascade supplies
inter-fault contraction and is otherwise
textbook. Three extension layers (orange, framed bottom) hook in at
