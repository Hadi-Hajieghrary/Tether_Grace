% Methods chapter included by tether_grace_reference.tex and by the
% IEEE T-CST main manuscript. Keep the derivations aligned with the
% implementations under Research/cpp/src/.
