...
with pre-tensioned initial conditions removing the startup
residual, peak tension is governed by the instantaneous
fault-response transient rather than by accumulated pickup-phase
energy. Tracking error is essentially invariant across B--D
($\NEWRmsB$, $\NEWRmsC$, $\NEWRmsD~\si{\metre}$),
